...
export default function HomeBanner({ onCursor }) {
    ...
    const [lastX, setLastX] = useState(moving ? currentX : null);
    const [lastY, setLastY] = useState(moving ? currentY : null);
    const [currentX, setCurrentX] = useState(moving ? lastX : null);
    const [currentY, setCurrentY] = useState(moving ? lastY : null);
